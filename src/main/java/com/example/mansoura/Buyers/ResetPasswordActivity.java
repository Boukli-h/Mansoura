...
public class ResetPasswordActivity extends AppCompatActivity {   //initialisation
    ...
    private void setAnswers()
    {
        ...
        {
            Toast.makeText(ResetPasswordActivity.this, "Please, answer a questions", Toast.LENGTH_SHORT).show();
        }
        else
        {
            ...
            ref.child("Security Questions").updateChildren(userdataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                {
                    Toast.makeText(ResetPasswordActivity.this, "your answers were updated successfully.", Toast.LENGTH_SHORT).show();
    ...
    //method to retrieve the previous answers
    private void displayPreviousAnswers()
    {
        ...
        ref.child("Security Questions").addValueEventListener(new ValueEventListener() {
            ...
            {   if(datasnapshot.exists())
            {
                ...
                question1.setText(ans1); //display
